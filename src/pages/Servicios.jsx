...
import ModalAgregarServicio from "../components/ModalAgregarServicio"; // Importa el componente Modal
  ...
  return (
    <div className="p-4">
      ...
      <div className="flex justify-between items-center mt-4 mb-4 border border-gray-300 rounded p-4">
        <h1 className="font-bold">Listado de Paquetes</h1>
      </div>
      ...
      <table className="min-w-full bg-white border border-gray-300">
        ...
        <tbody>
          {paquetes.map((paquete) => (
            <tr key={paquete.codigo_paquete} className="hover:bg-gray-100">
